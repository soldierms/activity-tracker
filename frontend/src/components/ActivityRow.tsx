  ...
  return (
    <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-700 py-3 last:border-0">
      <div className="flex items-center gap-3">
        <span
          className={`text-lg ${
            activity.status === "completed" ? "text-emerald-600" : "text-slate-400 dark:text-slate-500"
          }`}
        >
      ...
      <div className="flex items-center gap-2 text-sm">
        <button onClick={onEdit} className="text-slate-400 dark:text-slate-500 hover:text-indigo-600">
          Edit
        </button>
