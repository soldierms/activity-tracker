# Lets GitHub Actions assume an AWS role without storing long-lived AWS
# access keys as GitHub secrets — the workflow requests a short-lived token
# from AWS STS using GitHub's own OIDC identity token.
...
output "github_actions_role_arn" {
  description = "Add this as the AWS_DEPLOY_ROLE_ARN secret in the GitHub repo"
